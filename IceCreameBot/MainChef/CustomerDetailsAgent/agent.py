...
CustomerDetailsAgent = Agent(
    ...
    Important: If at any point, customer want to guest checkout, set customer_name="Guest", phone_number=None, customer_id=None. 
    ...
    - On confirm: write customer_id, customer_name, phone_number, address, discount (if returned). and hand off to CheckoutAgent without saying anything.
    ...
    - If registered successfully, hand off to CheckoutAgent without saying anything.
    - Guest path: set customer_name="Guest"; phone_number=""; address=None; discount=None; customer_id=None. and hand off to CheckoutAgent without saying anything.
    - If add_customer fails, apologize once and offer guest checkout.
